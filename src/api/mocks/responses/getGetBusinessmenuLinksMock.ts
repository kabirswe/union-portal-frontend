...
export const getGetBusinessmenuLinksMock: () => MenuListResponse = () => ({
  ...commonResponse,
  BusinessData: {
    ...
    Bodies: [
      ...
      },
      {
        "LinkCode": '342',
        "LinkCategoryCode": '101',
        "LinkName": "商品系ＤＷＨファイルサービス_",
        "LinkUrl": "https://dwppwap01.aeon.jusco.co.jp/adams2/resources/fileservice.html",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
        "LinkCode": '346',
        "LinkCategoryCode": '101',
        "LinkName": "商品系ＤＷＨ　会社横並び 単品ベスト100",
        "LinkUrl": "https://dwppwap01.aeon.jusco.co.jp/adams2/companybest100/companyselect",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
        "LinkCode": '347',
        "LinkCategoryCode": '101',
        "LinkName": "商品系ＤＷＨ　ＰＢ商品ランキング実績情報",
        "LinkUrl": "https://dwppwap01.aeon.jusco.co.jp/adams2/pbranking/menu?errflg=1",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
      ...
      },
      {
        "LinkCode": '645',
        "LinkCategoryCode": '403',
        "LinkName": "束プロ（バーコードプロモーション管理システム）",
        "LinkUrl": "http://bpmdb01/BPM_intra/scripts/login.asp",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
        "LinkCode": '650',
        "LinkCategoryCode": '403',
        "LinkName": "AEON-BPOS（ボーナスポイント管理システム）",
        "LinkUrl": "https://bpos.aeonpeople.biz/wbp_intra/scripts/top.asp",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
      ...
      },
      {
        "LinkCode": '838',
        "LinkCategoryCode": '403',
        "LinkName": "CSC業務分析レポート(イオンリテールストア用)",
        "LinkUrl": "http://160.243.129.213/syataku/csc/csc_aeon_retailstore.html",
        "MandatoryFlg": true,
        "CommonLinkFlg": false
      },
      {
        ...
        "LinkName": "利用者DB管理者サイト",
        "LinkUrl": "http://cosdbmgr/scripts/CUGA001.asp",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
        ...
        "LinkCategoryCode": '900',
        "LinkName": "資産管理システム",
        "LinkUrl": "http://ecmmsv01:42424/projects/aeons000/aeons000.aspx",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
        ...
        "LinkName": "【TEST】COSMOSニュース",
        "LinkUrl": "http://aeonsso/scripts/BD105_CSGA003.asp",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
      ...
      },
      {
        "LinkCode": '989',
        "LinkCategoryCode": '999',
        "LinkName": "トップバリュフレンズ（トップバリュ従業員Webサイト）",
        "LinkUrl": "http://staff.topvalu.net/auth/login/finish/",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
        ...
        "LinkCategoryCode": '999',
        "LinkName": "予算システム（テスト）",
        "LinkUrl": "http://160.243.90.153/yosan/index.htm",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
        ...
        "LinkCategoryCode": '999',
        "LinkName": "ログインテスト",
        "LinkUrl": "http://postnj9s01v:8080/Kpi_Analy_Site/Form/Kpi_Login.aspx",
        "MandatoryFlg": false,
        "CommonLinkFlg": false
      },
      {
