...
import type { MenuLinkCommunicationTool } from './menuLinkCommunicationTool';

export type CommunicationToolsListResponseAllOfBusinessData = {
  MetaInfos: CommonResponseMetaListResult;
  Bodies: MenuLinkCommunicationTool[];
};
